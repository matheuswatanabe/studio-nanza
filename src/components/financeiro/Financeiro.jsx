...
import TransacaoEditForm, { CamposTransacao } from "@/components/financeiro/CamposTransacao";
import {
  FORM_INICIAL,
  MESES,
  STATUS_ESTILO,
  ...
  hojeISO,
  statusReal,
} from "@/components/financeiro/utilitarios";

export default function Financeiro({ transacoesIniciais, projetosIniciais }) {
